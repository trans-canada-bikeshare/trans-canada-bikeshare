...
| 030 | [Analytical integrity](030-analytical-integrity.md) | Complete — Weather scenario; one completeness declaration; 15 schema contracts |
| 031 | [Open-source operations](031-open-source-operations.md) | Complete — CI hardened, community set, v1.0.0 with provenance |
| 032 | [Portfolio surface](032-portfolio-surface.md) | Complete — mobile nav, tables, social card, CSP proven against the maps |
